...
namespace RegistrationsManagement.Registrations
{
    internal class SqlQueries
    {
        ...
        public static int CreateRegistrationPathwayForLrs(int profileId)
        {
            ...
            var GetTQProviderID = "select top 1 TQP.Id from TqProvider TQP, TqAwardingOrganisation TQAO, TLProvider TLP, TlPathway TLPath where TQP.TlProviderId = TLP.Id and TQP.TqAwardingOrganisationId = TQAO.Id and TQAO.TlPathwayId = TLPath.Id and TLPath.TlevelTitle = 'T Level in Education and Childcare' and TLP.Name = 'Dudley College of Technology' and TQAO.TlAwardingOrganisatonId = 1";
            var TQProviderID = SqlDatabaseConncetionHelper.ReadDataFromDataBase(GetTQProviderID, ConnectionString);
            
            var createRegPathway = "Insert into TqRegistrationPathway values('" + profileId + "', '" + TQProviderID[0][0] + "','2020', GETDATE(),NULL,1,1,GETDATE(),'System',NULL,NULL)";
