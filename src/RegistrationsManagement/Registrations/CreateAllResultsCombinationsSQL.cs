...
{
    internal class CreateAllResultsCombinationsSQL
    {
        ...
        public static void CreateRegistration(string uln, string CreateCoreGrade, string CreateSpecialismGrade, string Year, String TLEVEL, string Provider, string IPStatus, string MathsStatus, String EnglishStatus, String Name, String Surname)
        {
            var profileId = CreateRegistrationProfile(uln, MathsStatus, EnglishStatus, Name, Surname);
        ...
        public static int CreateRegistrationProfile(string uln, string MathsStatus, String EnglishStatus, String Name, String Surname)
        {
            ...
            if (MathsStatus == "Null")
            {
                ...
                {
                    createRegistrationProfile = "Insert into TqRegistrationProfile values(" + uln + ", '" + Name + "','" + Surname + "','2001-01-01''2001-01-01',Null,1,1,Null,0,Null,Null,GETDATE(),'System', GETDATE(),'System')";
                }
                else
                {
                    createRegistrationProfile = "Insert into TqRegistrationProfile values(" + uln + ", '" + Name + "','" + Surname + "','2001-01-01',Null,1,1,Null,0,Null," + EnglishStatus + "3,GETDATE(),'System', GETDATE(),'System')";

                }
            }
            else if (EnglishStatus == "Null")
            {                
                    createRegistrationProfile = "Insert into TqRegistrationProfile values(" + uln + ", '" + Name + "','" + Surname + "','2001-01-01',Null,1,1,Null,0," + MathsStatus + ",Null,GETDATE(),'System', GETDATE(),'System')";
            }
            else
            {
                    createRegistrationProfile = "Insert into TqRegistrationProfile values(" + uln + ", '" + Name + "','" + Surname + "','2001-01-01',Null,1,1,Null,0," + MathsStatus + "," + EnglishStatus + ",GETDATE(),'System', GETDATE(),'System')";
            }
