...
#line hidden
        ...
        public virtual void _4708_AttemptToAddTheCurrentAssessmentSeriesToANewRegistration()
        {
            string[] tagsOfScenario = new string[] {
                    "RegressionTest",
                    "AssessmentEntriesUpload"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("4708_Attempt to add the current assessment series to a new registration", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
