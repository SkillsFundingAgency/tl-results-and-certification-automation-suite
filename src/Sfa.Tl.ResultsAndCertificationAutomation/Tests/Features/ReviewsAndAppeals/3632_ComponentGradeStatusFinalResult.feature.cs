...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Tests/Features/ReviewsAndAppeals", "3632 Post Results Services - Component grade status - Final result", "\tAs an AO, \r\n\tI need to know that the learner’s core component has been successfu" +
                    ...
                    " outcome of the appeal.", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        public void _3632_ValidateCoreComponentGradeStatusShowsGradeStatusAsFINALWhenGradeWasKeptTheSameAfterAppeal()
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("3632_Validate Core Component Grade Status shows grade status as \'FINAL\' when grad" +
                    "e was kept the same after appeal", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 13
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("RegressionTest")]
        [NUnit.Framework.CategoryAttribute("ReviewsAndAppeals")]
        public void _3632_ValidateCoreComponentGradeStatusShowsGradeStatusAsFINALWhenGradeWasAppealed()
        {
            string[] tagsOfScenario = new string[] {
                    "Ignore",
                    "RegressionTest",
            ...
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("3632_Validate Core Component Grade Status shows grade status as \'FINAL\' when grad" +
                    "e was appealed", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 24
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("RegressionTest")]
        [NUnit.Framework.CategoryAttribute("ReviewsAndAppeals")]
        public void _3632_VerifyBreadcrumbsAndSearchAgainButtonOnCoreComponentGradeStatusPageAfterFINALStatusIsShown()
        {
            string[] tagsOfScenario = new string[] {
                    "Ignore",
                    "RegressionTest",
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("3632_Verify breadcrumbs and Search again button on Core Component Grade Status pa" +
                    "ge after FINAL status is shown", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 38
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
