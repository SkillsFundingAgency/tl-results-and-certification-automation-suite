...
Given I have a <ULN> with core result of "Grade: A*" with core "Agriculture, Environmental and Animal Care (77777777)" and assessment series "Summer 2021" and specialism "Agriculture, Land Management and Production (70000002)"
When I press the Change link on the Results Learners Results page
Then the Results Change Result page is displayed for is displayed for the registration with core "Agriculture, Environmental and Animal Care (77777777)" and assessment series of "Summer 2021"
