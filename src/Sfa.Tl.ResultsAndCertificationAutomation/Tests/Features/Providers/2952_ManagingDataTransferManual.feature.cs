...
#line hidden
        ...
        public virtual void _2952_LearnerRecordShowsActiveIPWithNewProvider()
        {
            string[] tagsOfScenario = new string[] {
                    "RegressionTest",
                    "Provider"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("2952_Learner record shows active IP with new provider", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 18
