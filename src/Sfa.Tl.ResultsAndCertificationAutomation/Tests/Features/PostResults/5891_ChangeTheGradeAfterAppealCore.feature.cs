...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Tests/Features/PostResults", "5891_ChangeTheGradeAfterAppealCore", "As an AO, I need the ability to change the grade after a APPEAL outcome, so that " +
                    "the learners record is updated with any change to the grade", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        public virtual void _5891ChangeTheCoreGradeAfterAppeal()
        {
            string[] tagsOfScenario = new string[] {
                    "RegressionTest",
                    "PostResults"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("5891 Change the core grade after appeal", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 9
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("RegressionTest")]
        [NUnit.Framework.CategoryAttribute("PostResults")]
        public virtual void _5891ValidateErrorsOnChangeTheGradeAfterAppealPage()
        {
            string[] tagsOfScenario = new string[] {
                    "RegressionTest",
                    "PostResults"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("5891 Validate errors on change the grade after appeal page", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 19
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
        ...
        [NUnit.Framework.CategoryAttribute("RegressionTest")]
        [NUnit.Framework.CategoryAttribute("PostResults")]
        public virtual void _5891ChangeTheCoreGradeAfterAppealFromAddAppeal()
        {
            string[] tagsOfScenario = new string[] {
                    "RegressionTest",
                    "PostResults"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("5891 Change the core grade after appeal from add appeal", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 33
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
