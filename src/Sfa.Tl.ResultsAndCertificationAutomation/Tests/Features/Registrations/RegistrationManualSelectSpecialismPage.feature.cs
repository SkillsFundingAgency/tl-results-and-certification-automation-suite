...
#line hidden
        ...
        public virtual void VerifyRegistrationSelectSpecialismPage(string uln, string firstName, string lastName, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify Registration Select Specialism Page", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 10
...
#line hidden
        ...
        public virtual void VerifyRegistrationSelectSpecialismErrorPage(string uln, string firstName, string lastName, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("First Name", firstName);
            argumentsOfScenario.Add("Last Name", lastName);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Verify Registration Select Specialism Error Page", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 24
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
