...
#line hidden
        ...
        public void SearchRegistrationsWithValidUln(string uln, string firstName, string lastName, string day, string month, string year, string provider, string core, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Search Registrations With Valid Uln", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 11
